...
that. `dot --help` lists every command. The engine is POSIX shell; settings use macOS's own tools, plus
Homebrew, git, 1Password and `gh` where needed. It's agent-friendly: agents
check freely and ask before applying (see [AGENTS.md](AGENTS.md)).
